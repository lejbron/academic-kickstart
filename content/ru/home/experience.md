...
[[experience]]
  ...
  date_end = ""
  description = """
  Управление разработкой документации для микросервисного приложения с применением методики [documentation as code](https://www.writethedocs.org/guide/docs-as-code/).
